...
class Folder
{
   ...
   public static function GetFirstExisting( string $folder ) : string
   {
      ...
      if ( \Niirrty\strContains( $folder, '/' ) && \Niirrty\strContains( $folder, '\\' ) )
      {
    ...
    * @throws \Niirrty\IO\IOException If creation fails
    */
   ...
   public static function GetRealPath( string $folder, string $basePath ) : string
   {
      ...
      while ( \Niirrty\strStartsWith( $folder, '..' . \DIRECTORY_SEPARATOR ) )
      {
    ...
    * @throws \Niirrty\IO\FileAlreadyExistsException If the ZIP exists, and overwriting is disabled.
    * @throws \Niirrty\IO\IOException                  In all other error cases, while ZIP writing.
    */
