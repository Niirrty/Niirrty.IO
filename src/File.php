...
class File
{
    ...
    * @return \Niirrty\IO\File                       Returns the newly created File instance
    * @throws \Niirrty\IO\FileAlreadyExistsException If file exists and overwriting is disabled.
    ...
    * @return \Niirrty\IO\File                       Returns the File instance
    * @throws FileAccessException        On errors while opening the file pointer
    */
    ...
    * @param  boolean $lockExclusive       If $lock is TRUE, use exclusive file locking? (default=FALSE)
    * @return \Niirrty\IO\File                  Returns the newly created File instance
    * @throws \Niirrty\IO\FileNotFoundException If the file not exists
    * @throws FileAccessException   On errors while opening the file pointer
    */
    ...
    * @throws \Niirrty\IO\FileNotFoundException      If the $srcFile does not exist.
    * @throws \Niirrty\IO\FileAlreadyExistsException If $targetFile exists and overwriting is disabled.
    * @throws \Niirrty\IO\IOException
    */
    ...
    * @throws \Niirrty\IO\FileAccessException If creating the ZIP file fails.
    * @throws \Niirrty\IO\IOException
    */
    ...
    * @throws \Niirrty\IO\FileNotFoundException  If the ZIP file dont exists.
